  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-black opacity-50 p-6">
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
        <button className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-3 rounded inline-flex items-center" type='button' onClick={() => Router.push('/login')} >
